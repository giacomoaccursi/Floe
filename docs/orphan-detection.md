...
**orders** (unchanged - it's Delta, no new data in this batch)
| order_id | customer_id | total |
|----------|-------------|-------|
| O1       | C1          | 100   |
| O2       | **C2**      | 200   |
...
**customers**: C1, C3
**orders**: O1, O2, O3 (O2 and O3 are reported as orphans)
**order_items**: I1, I2, I3 (not checked because warn does not propagate)
