...
class FlowExecutor(
   ...
   */
  private def createSuccessResult(batchId: String, metrics: FlowMetrics): FlowResult = {
    FlowResult.success(
      flowConfig.name,
      batchId,
      metrics.inputCount,
   ...
   */
  private def createFailureResult(batchId: String, error: Throwable): FlowResult = {
